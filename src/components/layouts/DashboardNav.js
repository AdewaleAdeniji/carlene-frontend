        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            ...
            <button
              ...
              className=" p-2 text-gray-500 rounded-lg hidden sm:hidden hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700"
              onClick={() => setOpenAppMenu(!openAppMenu)}
            >
            ...
            <div
              className={`z-20 z-50 ${
                openAppMenu ? "block" : "hidden"
              } max-w-sm my-4 overflow-hidden text-base list-none bg-white divide-y divide-gray-100 rounded shadow-lg dark:bg-gray-700 dark:divide-gray-600`}
              id="apps-dropdown"
              style={{
                position: "absolute",
                inset: "0px auto auto 0px",
                margin: "0px",
                transform: "translate(70vw, 65px)",
              }}
            >
